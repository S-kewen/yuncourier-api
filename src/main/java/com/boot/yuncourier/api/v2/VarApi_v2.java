package com.boot.yuncourier.api.v2;
...
//描述方法用途和注意事項
    ...
    public Map<String, Object> pushMessage(String id, String token, String timestamp, String random, String sign,String mac) throws Exception {
        ...
        if (firewallCheck == null) {
            map.put("status", 0);
            map.put("tip", "success");
            map.put("title", util.StrToBase64(var.getTitle()));
            map.put("content",  util.StrToBase64(rsaEncryptUtil.encrypt(var.getContent(),publicKey)));
